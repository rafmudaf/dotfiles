...
# Aliases and Functions
  ...
  alias pv='/Applications/ParaView-5.3.0.app/Contents/MacOS/paraview'
  alias ~="cd ~"                              # ~:            Go Home
...
# Set Path
  PATH="/usr/local/git/bin:/sw/bin:/usr/local:/usr/local/sbin:/usr/local/mysql/bin:$PATH"

  # MAP++
  DYLD_LIBRARY_PATH="/Users/rmudafor/Desktop/MAP_v1.20.10/src${DYLD_LIBRARY_PATH:+:${DYLD_LIBRARY_PATH}}"

  # OPENFAST
  PATH="/Users/rmudafor/Development/openfast/install/bin:$PATH"
